 ...
 */
export const DataList = <T extends object>({ queryOptions, queryClient, ...props }: DataListProps<T>) => {
	const { data, fetchNextPage, hasNextPage, isLoading } = useInfiniteQuery(queryOptions, queryClient);
