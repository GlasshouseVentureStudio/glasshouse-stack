...
import { ScrollAreaShadow } from '../scroll-shadow';

const meta: Meta<typeof ScrollAreaShadow> = {
	title: 'Components/ScrollAreaShadow',
	component: ScrollAreaShadow,
	tags: ['autodocs'],
	decorators: [
		renderChildren => (
			<Paper
...
type ScrollAreaShadowStory = StoryObj<typeof meta>;
...
export const Default: ScrollAreaShadowStory = {
	args: {
		h: 300,
	},
	render: args => (
		<ScrollAreaShadow {...args}>
			<Stack p={20}>
...
export const Horizontal: ScrollAreaShadowStory = {
	...Default,
	args: {
		...Default.args,
		h: 300,
...
export const ShadowSize: ScrollAreaShadowStory = {
	...Default,
	args: {
		...Default.args,
		h: 300,
