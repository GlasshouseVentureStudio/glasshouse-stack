...
import GVSStack from './assets/gvs-stack.svg';

<Meta title='Glasshouse Stack' />

<div className='sb-container'>
	<div className='sb-section-title'>
      <img src={GVSStack} alt="Glasshouse Stack" className="sb-explore-image"/>
	</div>

    <div className='gvs-flex gvs-gap-2'>
